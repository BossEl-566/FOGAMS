...
import { createMembership, deleteMembership, getMembership, sendBirthdaySMS, updateMembership, getTodayBirthdays, deleteByUserId } from '../controllers/membership.controller.js';
...
router.delete('/delete-by-user/:userId', verifyToken, deleteByUserId);
