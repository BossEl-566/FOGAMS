...
console.log("create tithe:", createTitheFormData);
  ...
  const getMembers = async () => {
    try {
        ...
        if (Array.isArray(data)) {
            ...
            setAllMembers([]); // Default to empty array
        }
    ...
    const getRecordForUpdate = async (e) => {
      ...
      try {
        ...
        setPrevRecord(data); // Update prevRecord
  ...
  <div className="text-center">
    ...
    <form onSubmit={handleUpdateRecord}>
      ...
      <div className="mb-4">
        ...
        <input
          value={updateFormData.amount} // Use updateFormData instead of prevRecord
    ...
    <Modal show={updateTitheModal} onClose={() =>
      setUpdateTitheModal(false)
    } popup size="lg">
      <Modal.Header />
      <Modal.Body>
