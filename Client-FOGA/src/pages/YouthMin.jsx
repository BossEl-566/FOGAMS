      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Hear from young people whose lives have been changed
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full overflow-hidden mr-4">
                  <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" alt="Youth member" className="w-full h-full object-cover" />
                </div>
                <div>
                  <h4 className="font-bold text-gray-800">Sarah M.</h4>
                  <p className="text-sm text-pink-500">Age 17</p>
                </div>
              </div>
              <p className="text-gray-600">
                "The youth ministry helped me find real friends who support me in my faith journey. I've grown so much spiritually through the Bible studies!"
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full overflow-hidden mr-4">
                  <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" alt="Youth member" className="w-full h-full object-cover" />
                </div>
                <div>
                  <h4 className="font-bold text-gray-800">James L.</h4>
                  <p className="text-sm text-blue-500">Age 19</p>
                </div>
              </div>
              <p className="text-gray-600">
            ...
            >
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full overflow-hidden mr-4">
                  <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" alt="Youth member" className="w-full h-full object-cover" />
                </div>
                <div>
                  <h4 className="font-bold text-gray-800">Emily T.</h4>
                  <p className="text-sm text-purple-500">Age 16</p>
                </div>
              </div>
              <p className="text-gray-600">
                "I was nervous to come at first, but everyone was so welcoming. Now it's my favorite place to be! The events are fun and the messages are relevant."
              </p>
            </motion.div>
          </div>
        </div>
